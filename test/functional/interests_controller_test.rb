...
class InterestsControllerTest < ActionController::TestCase
  ...
  test "should create interest" do
    assert_difference('Interest.count') do
      post :create, interest: { created_by: @interest.created_by, deleted: @interest.deleted, desciption: @interest.desciption, updated_by: @interest.updated_by }
    end
  ...
  test "should update interest" do
    put :update, id: @interest, interest: { created_by: @interest.created_by, deleted: @interest.deleted, desciption: @interest.desciption, updated_by: @interest.updated_by }
    assert_redirected_to interest_path(assigns(:interest))
  end
